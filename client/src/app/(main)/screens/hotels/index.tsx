...
const data = [
  {
    ...
    hotelImage: require("@/src/assets/images/grand_river_view_hotel.png"),
    hotelName: "Grand River View Hotel",
    thana: "Rajpara",
    address: "Rajshahi",
  },
  {
    ...
    adderName: "Nissan",
    adderImage: require("@/src/assets/images/man_logo.png"),
    hotelImage: require("@/src/assets/images/hotel_x.png"),
    hotelName: "Hotel X",
    thana: "Rajpara",
    address: "Rajshahi",
  },
...
const Index = () => {
      ...
      <View style={styles.hospitalContainer}>
        ...
        <View style={styles.hospitalInfo}>
          ...
          <View style={styles.infoContainer}>
            <Text style={styles.hospitalName}>{item.hotelName}</Text>
  ...
  return (
     <SafeAreaView style={styles.container}>
          <CustomNavbar />
          <SearchInput placeholderText="হোটেল খুজুন ... " />
